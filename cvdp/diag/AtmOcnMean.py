...
def mean_seasonal_calc(ref_dataset, sim_dataset, var_name):
    ...
    ref_seas_avgs, ref_seas_ts  = compute_seasonal_avgs(ref_dataset, var_name)
    ...
    sim_seas_avgs, sim_seas_ts = compute_seasonal_avgs(sim_dataset, var_name)
    ...
    return ref_seas_avgs, sim_seas_avgs, ref_seas_ts, sim_seas_ts